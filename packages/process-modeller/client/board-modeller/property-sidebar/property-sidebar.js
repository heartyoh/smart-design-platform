      ...
      <div content>
        ${html`
          ${{
            ...
            `,
            effect: html`
              <process-property-effect .value=${this.model} .scene=${this.scene} ?active=${tabIndex == 'effect'}>
            ...
            'data-binding': html`
              <process-property-data-binding
                .scene=${this.scene}
                .value=${this.model}
                ?active=${tabIndex == 'data-binding'}
              >
              </process-property-data-binding>
            `,
            inspector: html`
              <process-scene-inspector
                .scene=${this.scene}
                ?active=${tabIndex == 'inspector'}
              ></process-scene-inspector>
            `
          }[this.tabIndex]}
        `}
