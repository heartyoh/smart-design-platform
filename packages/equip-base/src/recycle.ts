...
const RECYCLE_IMAGE = `
  ...
  <style type="text/css">
    .st0{display:none;}
    .st1{display:inline;}
    .st2{fill:none;stroke:{{fontColor}};stroke-width:2;stroke-miterlimit:10;}
  </style>
  ...
  <g id="Layer_2">
    <g>
      <path class="st2" d="M6.4,25.6V4.1h9.1c2.3,0,4,0.2,5,0.6c1,0.4,1.9,1.1,2.5,2.1s0.9,2.1,0.9,3.4c0,1.6-0.5,2.9-1.4,4s-2.4,1.7-4.2,2
